...
Little is known about Dover Forest’s land history prior to the 1900s. However, in more recent history, the land now known as the Dover Forest had been previously known as the Chua Kampung. Chua Chintat, an advocate of the Dover Forest <param ve-video id="jnFJPVYcZEE&t=14s" title="One person's quest to save Dover Forest | Jom">, had family members who lived in the Chua Kampung. Though Chintat did not grow up in the kampung and had only visited a few times as a child, he recalled some of the origins of its people.
